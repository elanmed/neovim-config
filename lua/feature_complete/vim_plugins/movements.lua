...
vim.keymap.set("n", "]a", function()
  marks.navigate_buffer_marks { direction = "next" }
end)
vim.keymap.set("n", "[a", function()
  marks.navigate_buffer_marks { direction = "prev" }
end)
vim.keymap.set("n", "]r", function()
  marks.navigate_global_marks { direction = "next" }
end)
vim.keymap.set("n", "[r", function()
  marks.navigate_global_marks { direction = "prev" }
end)
