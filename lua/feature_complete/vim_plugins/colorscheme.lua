...
vim.api.nvim_set_hl(0, "Operator", { fg = M.extra_light_grey, })
vim.api.nvim_set_hl(0, "PreCondit", { fg = M.yellow, })
vim.api.nvim_set_hl(0, "PreProc", { fg = M.yellow, })
vim.api.nvim_set_hl(0, "Repeat", { fg = M.yellow, })
